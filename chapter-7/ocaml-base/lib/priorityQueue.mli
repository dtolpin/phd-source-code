...
val make: 'a order -> int -> 'a t
(** [make ord cap] creates a new priority queue with order [ord]
    and initial capacity [cap]. *)
...
(** [extract_first q] removes and returns the element returned by [first q]
    from the queue [1]. *)
